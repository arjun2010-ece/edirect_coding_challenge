...
exports.editTask = async (req) => {
    await taskModal.update(req.body, {where: {id: req.params.taskId}});
...
exports.editTaskStatus = async (req) => {
    await taskModal.update({status: req.body.status}, {where: {id: req.params.taskId}});
    return req.params.taskId;
}
